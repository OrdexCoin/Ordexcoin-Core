...
#ifndef ORDEXCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define ORDEXCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // ORDEXCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H

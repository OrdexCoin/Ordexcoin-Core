...
#ifndef ORDEXCOIN_WALLET_TRANSACTION_H
#define ORDEXCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this ordexcoin node, and set to 0 for transactions that were created
...
#endif // ORDEXCOIN_WALLET_TRANSACTION_H

...
#ifndef ORDEXCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define ORDEXCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The OrdexCoin Core wallet was originally a collection of unrelated private
...
#endif // ORDEXCOIN_WALLET_SCRIPTPUBKEYMAN_H

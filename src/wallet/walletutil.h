...
#ifndef ORDEXCOIN_WALLET_WALLETUTIL_H
#define ORDEXCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! ordexcoin from opening the wallet, thinking it was newly created, and
...
#endif // ORDEXCOIN_WALLET_WALLETUTIL_H

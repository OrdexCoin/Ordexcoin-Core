...
#ifndef ORDEXCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define ORDEXCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@ordexcoin.
 *
 ...
 *
 * The chacha20-poly1305@ordexcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@ordexcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@ordexcoin are relatively fast in
...
#endif // ORDEXCOIN_CRYPTO_CHACHA_POLY_AEAD_H

...
#ifndef ORDEXCOIN_SCRIPT_STANDARD_H
#define ORDEXCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a ordexcoin address
 */
...
/**
 * Generate a OrdexCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // ORDEXCOIN_SCRIPT_STANDARD_H

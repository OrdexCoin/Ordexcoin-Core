...
#ifndef ORDEXCOIN_SCRIPT_SCRIPT_H
#define ORDEXCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, OrdexCoin always counted CHECKMULTISIGs
...
#endif // ORDEXCOIN_SCRIPT_SCRIPT_H

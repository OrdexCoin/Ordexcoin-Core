...
{
    BOOST_CHECK(TestSplitHost("www.ordexcoincore.org", "www.ordexcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.ordexcoincore.org]", "www.ordexcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.ordexcoincore.org:80", "www.ordexcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ordexcoincore.org]:80", "www.ordexcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:25174", "127.0.0.1", 25174));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:25174", "127.0.0.1", 25174));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:25174", "::ffff:127.0.0.1", 25174));
    BOOST_CHECK(TestSplitHost("[::]:25174", "::", 25174));
    BOOST_CHECK(TestSplitHost("::25174", "::25174", 0));
    BOOST_CHECK(TestSplitHost(":25174", "", 25174));
    BOOST_CHECK(TestSplitHost("[]:25174", "", 25174));
    ...
    BOOST_CHECK(TestSplitHost("www.ordexcoincore.org:65536", "www.ordexcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.ordexcoincore.org:0", "www.ordexcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.ordexcoincore.org:", "www.ordexcoincore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:25174", "127.0.0.1:25174"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:25174", "[::]:25174"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));

...
#ifndef ORDEXCOIN_TEST_SCRIPTNUM10_H
#define ORDEXCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from OrdexCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ORDEXCOIN_TEST_SCRIPTNUM10_H

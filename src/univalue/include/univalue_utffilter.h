...
#ifndef ORDEXCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define ORDEXCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // ORDEXCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H

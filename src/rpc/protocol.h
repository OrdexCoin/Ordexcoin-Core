...
#ifndef ORDEXCOIN_RPC_PROTOCOL_H
#define ORDEXCOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in ordexcoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< OrdexCoin is not connected
...
#endif // ORDEXCOIN_RPC_PROTOCOL_H

...
#ifndef ORDEXCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define ORDEXCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // ORDEXCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H

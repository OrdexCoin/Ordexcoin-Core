...
#ifndef ORDEXCOIN_ARITH_UINT256_H
#define ORDEXCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * OrdexCoin only uses this "compact" format for encoding difficulty
...
#endif // ORDEXCOIN_ARITH_UINT256_H

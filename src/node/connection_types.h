...
#ifndef ORDEXCOIN_NODE_CONNECTION_TYPES_H
#define ORDEXCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/ordexcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on OrdexCoin’s Peer-to-Peer Network")
...
#endif // ORDEXCOIN_NODE_CONNECTION_TYPES_H

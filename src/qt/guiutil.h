...
#ifndef ORDEXCOIN_QT_GUIUTIL_H
#define ORDEXCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the OrdexCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ordexcoin:" URI into recipient object, return true on successful parsing

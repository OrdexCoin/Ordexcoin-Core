      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->ordexcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ordexcoinAtStartup);
    ...
    ui->ordexcoinAtStartup->setToolTip(ui->ordexcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->ordexcoinAtStartup->setText(ui->ordexcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openOrdexCoinConfButton->setToolTip(ui->openOrdexCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new OrdexCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ordexcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSOXControls);
...
void OptionsDialog::on_openOrdexCoinConfButton_clicked()
{

...
//! Entry point for OrdexCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &OrdexCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for OrdexCoinGUI tests.
void AppTests::guiTests(OrdexCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &OrdexCoinGUI::consoleShown, this, &AppTests::consoleTests);

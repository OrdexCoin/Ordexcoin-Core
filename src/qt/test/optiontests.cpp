...
{
    // Test regression https://github.com/ordexcoin/ordexcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/ordexcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/ordexcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/OrdexCoin/OrdexCoin-Qt.conf and all else left as default,
    // ordexcoin-qt should set both -listen and -listenonion to false and start successfully.

...
#ifndef ORDEXCOIN_UTIL_MESSAGE_H
#define ORDEXCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's ordexcoin address, it must refer to a public key.
...
#endif // ORDEXCOIN_UTIL_MESSAGE_H

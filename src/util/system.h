 ...
 */
#ifndef ORDEXCOIN_UTIL_SYSTEM_H
#define ORDEXCOIN_UTIL_SYSTEM_H
...
extern const char * const ORDEXCOIN_CONF_FILENAME;
extern const char * const ORDEXCOIN_SETTINGS_FILENAME;

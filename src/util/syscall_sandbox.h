...
#ifndef ORDEXCOIN_UTIL_SYSCALL_SANDBOX_H
#define ORDEXCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during ordexcoind initialization if OrdexCoin Core was compiled
...
#endif // ORDEXCOIN_UTIL_SYSCALL_SANDBOX_H

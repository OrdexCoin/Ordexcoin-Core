...
#ifndef ORDEXCOIN_COMPAT_ASSUMPTIONS_H
#define ORDEXCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "OrdexCoin cannot be compiled without assertions."
#endif
...
#endif // ORDEXCOIN_COMPAT_ASSUMPTIONS_H

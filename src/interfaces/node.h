...
#ifndef ORDEXCOIN_INTERFACES_NODE_H
#define ORDEXCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a ordexcoin node (ordexcoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or ordexcoin.conf.
...
#endif // ORDEXCOIN_INTERFACES_NODE_H

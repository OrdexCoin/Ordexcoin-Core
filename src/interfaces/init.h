...
#ifndef ORDEXCOIN_INTERFACES_INIT_H
#define ORDEXCOIN_INTERFACES_INIT_H
...
//! (ordexcoin-gui, ordexcoin-node, ordexcoin-wallet, ordexcoind, ordexcoin-qt) and each
...
#endif // ORDEXCOIN_INTERFACES_INIT_H

...
"""Example logging OrdexCoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/ordexcoind
...
def main(ordexcoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[ordexcoind_with_usdts])

...
""" Interactive ordexcoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for OrdexCoin Core can enable. It uses BCC
...
def main(ordexcoind_path):
    ...
    ordexcoind_with_usdts.enable_probe(

...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ORDEXCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define ORDEXCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the ordexcoin network\n')
    ...
    g.write('#endif // ORDEXCOIN_CHAINPARAMSSEEDS_H\n')

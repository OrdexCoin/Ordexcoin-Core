...
complete --command ordexcoind --no-files

# Extract options
function __fish_ordexcoind_get_options
...
complete \
    --command ordexcoind \
    --arguments "(__fish_ordexcoind_get_options --nofiles)"

...
complete --command ordexcoin-qt --no-files

# Extract options
function __fish_ordexcoinqt_get_options
...
complete \
    --command ordexcoin-qt \
    --arguments "(__fish_ordexcoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c ordexcoin-qt \
...
complete \
    --command ordexcoin-qt \
    --arguments "(__fish_ordexcoinqt_get_options --nofiles)"

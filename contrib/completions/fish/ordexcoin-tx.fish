...
# Extract options
function __fish_ordexcoin_tx_get_options
...
# Extract commands
function __fish_ordexcoin_tx_get_commands
...
# Add options
complete \
    --command ordexcoin-tx \
    --condition "not __fish_ordexcoin_seen_cmd (__fish_ordexcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_ordexcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command ordexcoin-tx \
    --arguments "(__fish_ordexcoin_tx_get_commands)" \
    --no-files

...
This document provides guidelines for internationalization of the OrdexCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ordexcoin_en.ts` remains unchanged.

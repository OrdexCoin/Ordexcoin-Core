OrdexCoin Core version 0.9.4 is now available from:

  https://ordexcoin.org/bin/0.9.4/
...
this update is incompatible with the OrdexCoin system and could lead to consensus
forks.

OrdexCoin Core released binaries from https://ordexcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~ordexcoin/+archive/ubuntu/ordexcoin
- A third-party or self-compiled OrdexCoin Core

upgrade to OrdexCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

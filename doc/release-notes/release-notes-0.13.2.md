OrdexCoin Core version 0.13.2 is now available from:

  <https://ordexcoin.org/bin/ordexcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update ordexcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow ordexcoin-tx to create v2 transactions (oxcdrak)

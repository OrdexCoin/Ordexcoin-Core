OrdexCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/ordexcoin/files/OrdexCoin/ordexcoin-0.5.4/
...
http://gitorious.org/ordexcoin/ordexcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix OrdexCoin-Qt notifications under Growl 1.3.
Increase required age of OrdexCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOrdexCoin properly when installing OrdexCoin-Qt over it. (Windows)

OrdexCoin Core version 0.10.4 is now available from:

  <https://ordexcoin.org/bin/ordexcoin-core-0.10.4/>
...
- #6953 `43c2789` Split ordexcoin-tx into its own package
- #6953 `dfe0d4d` Include ordexcoin-tx binary on Debian/Ubuntu

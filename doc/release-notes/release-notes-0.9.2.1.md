OrdexCoin Core version 0.9.2.1 is now available from:

  https://ordexcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 OXC to 0.01 OXC
...
- Fix "Start ordexcoin on system login"

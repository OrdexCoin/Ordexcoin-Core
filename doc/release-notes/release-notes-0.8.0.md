OrdexCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/ordexcoin/files/OrdexCoin/ordexcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the OrdexCoin
...
New/changed settings (command-line or ordexcoin.conf file)
--------------------------------------------------------

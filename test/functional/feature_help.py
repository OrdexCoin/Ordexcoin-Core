...
"""Verify that starting ordexcoin with -h works as expected."""

from test_framework.test_framework import OrdexCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(OrdexCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ordexcoin with -h for help text")
        ...
        self.log.info("Start ordexcoin with -version for version information")
        ...
        self.log.info("Start ordexcoind with -fakearg to make sure it does not start")

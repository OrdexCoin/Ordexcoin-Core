...
By default, ordexcoind will dump mempool on shutdown and
...
class MempoolPersistTest(OrdexCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent ordexcoind from writing mempool.dat to disk. Verify that `savemempool` fails")

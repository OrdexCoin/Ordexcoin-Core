...
class TestShell:
    """Wrapper Class for OrdexCoinTestFramework.

    The TestShell class extends the OrdexCoinTestFramework
    ...
    class __TestShell(OrdexCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by OrdexCoinTestFramework child class.
            self.num_nodes = 1

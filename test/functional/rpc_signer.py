...
Verify that a ordexcoind node can use an external signer command.
...
class RPCSignerTest(OrdexCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart ordexcoind with -signer=<cmd>',

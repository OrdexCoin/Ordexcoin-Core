...
class TxnMallTest(OrdexCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 OXC:
        ...
        # First: use raw transaction API to send 1240 OXC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 OXC coin each
        ...
        # Node0's balance should be starting balance, plus 50OXC for another
        ...
        # Node0's total balance should be starting balance, plus 100OXC for

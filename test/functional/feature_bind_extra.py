...
"""
Test starting ordexcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(OrdexCoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that ordexcoind has bound on "::1" (for RPC) and "::" (for P2P).

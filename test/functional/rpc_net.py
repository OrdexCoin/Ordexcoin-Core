...
class NetTest(OrdexCoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=25174)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 25174)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=25174), {"success": False})

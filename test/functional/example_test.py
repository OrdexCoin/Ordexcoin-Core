...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the OrdexCoinTestFramework
    pass


class ExampleTest(OrdexCoinTestFramework):
    # Each functional test is a subclass of the OrdexCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        OrdexCoinTestFramework class so other tests can use it."""

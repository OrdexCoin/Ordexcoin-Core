...
class TransactionTimeRescanTest(OrdexCoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine OXC and create transactions
        ...
        # generate some oxc to create transactions and check blockcount
        ...
        # send 10 oxc to user's first watch-only address
        self.log.info('Send 10 oxc to user')
        ...
        # send 5 oxc to our second watch-only address
        self.log.info('Send 5 oxc to user')
        ...
        # send 1 oxc to our third watch-only address
        self.log.info('Send 1 oxc to user')

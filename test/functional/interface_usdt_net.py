...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/ordexcoin/ordexcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(OrdexCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our ordexcoind node")
